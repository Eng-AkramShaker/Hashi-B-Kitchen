...
class DraftKitchenModel {
  ...
  factory DraftKitchenModel.fromJson(Map<String, dynamic> json) {
    return DraftKitchenModel(
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) {
    return Item(
      ...
      qty: (json["qty"] is double) ? (json["qty"] as double).toInt() : json["qty"] as int?,
    );
  }
