...
import 'package:face_auth_flutter/data/models/items/item_model.dart';
import 'package:face_auth_flutter/data/services/customers/customer_api.dart';
import 'package:face_auth_flutter/data/services/product/productes_api.dart';
...
// --------------------------------------
  ...
  fetch_group_product(context) async {
    await fetch_group_product_Api(context).then((value) {
